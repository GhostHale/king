...
<div id="header">
	...
	<p class="welcome">您好，欢迎登录掌金宝后台管理系统，当前时间：<span><?=date('Y-m-d H:i');?></span></p>
</div>
<div id="main">
	<div id="slider">
		<div class="block"></div>
		<div class="quit">
			...
			<span onclick="location.href='/doadmin/logout'">退出</span>
		</div>
		<div class="li">
			...
			<ul>
                ...
                <li class="zhongchou_guanli" onclick="location.href='#8'">抽奖活动管理</li>
            </ul>
        </div>
        <div class="li">
        ...
        <div class="li">
            <h1 class="choujiang" onclick="location.href='#9'">后台用户管理</h1>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function loadPage(id){
	    ...
	    switch(id){
	        ...
	        case '9':fra.attr('src','/doadmin/admin');break;
